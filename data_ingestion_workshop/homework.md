...
```
    ...
    Pipeline ny_taxi_pipeline load step completed in 1.76 seconds
    1 load package(s) were loaded to destination duckdb and into dataset ny_taxi_data
    The duckdb destination used duckdb:////content/ny_taxi_pipeline.duckdb location to store data
    Load package 1739567243.3587005 is LOADED and contains no failed jobs
...
# the name is ny_taxi_pipeline.duckdb
